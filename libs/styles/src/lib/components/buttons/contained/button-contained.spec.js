...
describe('Contained Button', () => {
  [
    ...
    },
    {
      label: 'hover',
      states: {
        '#xmas.uiseek-button-contained': ['hover'],
      },
      textColor: { r: 255, g: 255, b: 255, a: 255 },
    ...
    },
    {
      label: 'focus',
      states: {
        '#xmas.uiseek-button-contained': ['focus'],
      },
      textColor: { r: 255, g: 255, b: 255, a: 255 },
    ...
    },
    {
      label: 'active',
      states: {
        '#xmas.uiseek-button-contained': ['active'],
      },
      textColor: { r: 255, g: 255, b: 255, a: 255 },
      bodyColor: { r: 33, g: 150, b: 243, a: 255 },
      shadow: {
    ...
    },
    {
      label: 'hover & focus',
      states: {
        '#xmas.uiseek-button-contained': ['hover', 'focus'],
      },
      textColor: { r: 255, g: 255, b: 255, a: 255 },
    ...
    },
    {
      label: 'hover & active',
      states: {
        '#xmas.uiseek-button-contained': ['hover', 'active'],
      },
      textColor: { r: 255, g: 255, b: 255, a: 255 },
      bodyColor: { r: 50, g: 158, b: [243, 244], a: 255 },
      shadow: {
    ...
    },
    {
      label: 'focus & active',
      states: {
        '#xmas.uiseek-button-contained': ['focus', 'active'],
      },
      textColor: { r: 255, g: 255, b: 255, a: 255 },
      bodyColor: { r: [85, 86], g: 175, b: [245, 246], a: 255 },
      shadow: {
    ...
    },
    {
      ...
      states: {
        '#xmas.uiseek-button-contained': ['hover', 'focus', 'active'],
      },
      textColor: { r: 255, g: 255, b: 255, a: 255 },
      bodyColor: { r: [99, 104], g: [181, 184], b: [246, 247], a: 255 },
      shadow: {
    ...
    },
    {
      label: 'disabled',
      states: {
        '#xmas.uiseek-button-contained': ['disabled'],
      },
    ...
    },
    {
      label: 'customized',
      states: {
        '#xmas.uiseek-button-contained': {
          style:
            '--uiseek-primary-rgb: 255, 0, 0;--uiseek-onprimary-rgb: 0, 0, 0;width: 120px',
        },
      },
    ...
    describe(`in ${suite.label} state`, () => {
      ...
      beforeAll(async () => {
        style = setUp(
          'src/components/buttons/contained/button-contained',
          suite.states
        );
      ...
      it(`should have dominant ${JSON.stringify(suite.bodyColor).replace(
        /"/g,
        ''
      )} color`, () => {
      ...
      it('should have shadow', () => {
        const top = context.getImageData3x(
          SPACING,
          -SPACING,
          width - 2 * SPACING,
          SPACING
        ...
        const bottom = context.getImageData3x(
          SPACING,
          height,
          width - 2 * SPACING,
          SPACING
