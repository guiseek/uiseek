...
describe('Outlined Button', () => {
  [
    ...
    },
    {
      label: 'hover',
      states: {
        '#xmas.uiseek-button-outlined': ['hover'],
      },
      textColor: { r: 33, g: 150, b: 243, a: 255 },
    ...
    },
    {
      label: 'focus',
      states: {
        '#xmas.uiseek-button-outlined': ['focus'],
      },
      textColor: { r: 33, g: 150, b: 243, a: 255 },
    ...
    },
    {
      label: 'active',
      states: {
        '#xmas.uiseek-button-outlined': ['active'],
      },
      textColor: { r: 33, g: 150, b: 243, a: 255 },
      bodyColor: { a: 0 },
    ...
    },
    {
      label: 'hover & focus',
      states: {
        '#xmas.uiseek-button-outlined': ['hover', 'focus'],
      },
      textColor: { r: 33, g: 150, b: 243, a: 255 },
    ...
    },
    {
      label: 'hover & active',
      states: {
        '#xmas.uiseek-button-outlined': ['hover', 'active'],
      },
      textColor: { r: 33, g: 150, b: 243, a: 255 },
      bodyColor: { r: [25, 26], g: 153, b: 255, a: 10 },
      outlineColor: { r: 0, g: 0, b: 0, a: [60, 61] },
    },
    {
      label: 'focus & active',
      states: {
        '#xmas.uiseek-button-outlined': ['focus', 'active'],
      },
      textColor: { r: 33, g: 150, b: 243, a: 255 },
      bodyColor: { r: [26, 34], g: [148, 153], b: [246, 247], a: [30, 31] },
      outlineColor: { r: 0, g: 0, b: 0, a: [60, 61] },
    },
    {
      ...
      states: {
        '#xmas.uiseek-button-outlined': ['hover', 'focus', 'active'],
      },
      textColor: { r: 33, g: 150, b: 243, a: 255 },
      bodyColor: { r: [31, 32], g: [149, 153], b: [242, 243], a: [40, 41] },
      outlineColor: { r: 0, g: 0, b: 0, a: [60, 61] },
    },
    {
      label: 'disabled',
      states: {
        '#xmas.uiseek-button-outlined': ['disabled'],
      },
    ...
    },
    {
      label: 'customized',
      states: {
        '#xmas.uiseek-button-outlined': {
          style:
            '--uiseek-primary-rgb: 255, 0, 0;--uiseek-onsurface-rgb: 255, 255, 255;width: 120px',
        },
      },
    ...
    describe(`in ${suite.label} state`, () => {
      ...
      beforeAll(async () => {
        style = setUp(
          'src/components/buttons/outlined/button-outlined',
          suite.states
        );
