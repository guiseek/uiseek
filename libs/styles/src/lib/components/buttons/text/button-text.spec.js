...
describe('Text Button', () => {
  [
    ...
    },
    {
      label: 'active',
      states: {
        '#xmas.uiseek-button-text': ['active'],
      },
      textColor: { r: 33, g: 150, b: 243, a: 255 },
      bodyColor: { a: 0 },
    },
    {
      label: 'hover & focus',
      states: {
        '#xmas.uiseek-button-text': ['hover', 'focus'],
      },
      textColor: { r: 33, g: 150, b: 243, a: 255 },
    ...
    },
    {
      label: 'hover & active',
      states: {
        '#xmas.uiseek-button-text': ['hover', 'active'],
      },
      textColor: { r: 33, g: 150, b: 243, a: 255 },
      bodyColor: { r: [25, 26], g: 153, b: 255, a: 10 },
    },
    {
      label: 'focus & active',
      states: {
        '#xmas.uiseek-button-text': ['focus', 'active'],
      },
      textColor: { r: 33, g: 150, b: 243, a: 255 },
      bodyColor: { r: [26, 34], g: [148, 153], b: [246, 247], a: [30, 31] },
    },
    {
      ...
      states: {
        '#xmas.uiseek-button-text': ['hover', 'focus', 'active'],
      },
      textColor: { r: 33, g: 150, b: 243, a: 255 },
      bodyColor: { r: [31, 32], g: [149, 153], b: [242, 243], a: [40, 41] },
    },
    {
      label: 'disabled',
      states: {
        '#xmas.uiseek-button-text': ['disabled'],
      },
    ...
    describe(`in ${suite.label} state`, () => {
      ...
      it(`should have 4px round corners`, () => {
        ...
        const im = {
          a: [
            0,
            typeof suite.bodyColor.a === 'number'
              ? suite.bodyColor.a
              : suite.bodyColor.a[1],
          ],
        };
