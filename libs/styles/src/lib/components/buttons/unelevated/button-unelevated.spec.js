...
describe('Unelevated Button', () => {
  [
    ...
    },
    {
      label: 'hover',
      states: {
        '#xmas.uiseek-button-unelevated': ['hover'],
      },
      textColor: { r: 255, g: 255, b: 255, a: 255 },
    ...
    },
    {
      label: 'focus',
      states: {
        '#xmas.uiseek-button-unelevated': ['focus'],
      },
      textColor: { r: 255, g: 255, b: 255, a: 255 },
    ...
    },
    {
      label: 'active',
      states: {
        '#xmas.uiseek-button-unelevated': ['active'],
      },
      textColor: { r: 255, g: 255, b: 255, a: 255 },
      bodyColor: { r: 33, g: 150, b: 243, a: 255 },
    },
    {
      label: 'hover & focus',
      states: {
        '#xmas.uiseek-button-unelevated': ['hover', 'focus'],
      },
      textColor: { r: 255, g: 255, b: 255, a: 255 },
    ...
    },
    {
      label: 'hover & active',
      states: {
        '#xmas.uiseek-button-unelevated': ['hover', 'active'],
      },
      textColor: { r: 255, g: 255, b: 255, a: 255 },
      bodyColor: { r: 50, g: 158, b: [243, 244], a: 255 },
    },
    {
      label: 'focus & active',
      states: {
        '#xmas.uiseek-button-unelevated': ['focus', 'active'],
      },
      textColor: { r: 255, g: 255, b: 255, a: 255 },
      bodyColor: { r: [85, 86], g: 175, b: [245, 246], a: 255 },
    },
    {
      ...
      states: {
        '#xmas.uiseek-button-unelevated': ['hover', 'focus', 'active'],
      },
      textColor: { r: 255, g: 255, b: 255, a: 255 },
      bodyColor: { r: [99, 104], g: [181, 184], b: [246, 247], a: 255 },
    },
    {
      label: 'disabled',
      states: {
        '#xmas.uiseek-button-unelevated': ['disabled'],
      },
    ...
    describe(`in ${suite.label} state`, () => {
      ...
      beforeAll(async () => {
        style = setUp(
          'src/components/buttons/unelevated/button-unelevated',
          suite.states
        );
      ...
      it('should have no shadow', () => {
        const topShadow = context.getImageData3x(
          -SPACING,
          -SPACING,
          width + SPACING,
          SPACING
        );
        const rightShadow = context.getImageData3x(
          width,
          -SPACING,
          SPACING,
          height + SPACING
        );
        const bottomShadow = context.getImageData3x(
          0,
          height,
          width + SPACING,
          SPACING
        );
        const leftShadow = context.getImageData3x(
          -SPACING,
          0,
          SPACING,
          height + SPACING
