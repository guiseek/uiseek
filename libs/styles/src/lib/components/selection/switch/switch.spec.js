  ...
  [
    ...
    },
    {
      ...
      states: {
        '#xmas': {
          style:
            '--uiseek-primary-rgb: 255, 0, 0;--uiseek-surface-rgb: 0, 0, 0;--uiseek-onsurface-rgb: 255, 255, 255;width: 150px;',
        },
      },
    ...
    describe(`in ${suite.label} state`, () => {
      ...
      beforeAll(async () => {
        ...
        style +=
          '.uiseek-switch > input + span::after { box-shadow: none !important; }';
      ...
      it('should have track', () => {
        ...
        expect(track).toResembleCircularShape(
          slice,
          suite.checked ? 205 : 25,
          suite.checked ? 335 : 155
        );
      });
      ...
      it('should have a circular highlight representing state', () => {
        ...
        expect(highlight).toResembleCircularShape(
          slice,
          suite.checked ? 310 : 130,
          suite.checked ? 230 : 50
        );
      });
    });
  });
