  ...
  [
    ...
    },
    {
      ...
      states: {
        '#xmas': {
          indeterminate: '',
          style:
            'animation-delay: 0s; animation-play-state: paused; vertical-align: top;',
        },
      },
      fill: [0, 480],
      barColor: { ...baseColor, a: [30, 31] },
    ...
    },
    {
      ...
      states: {
        '#xmas': {
          indeterminate: '',
          style:
            'animation-delay: -0.45s; animation-play-state: paused; vertical-align: top;',
        },
      },
      fill: [0, 24, 262, 194],
      barColor: { ...baseColor, a: [30, 31] },
    ...
    },
    {
      ...
      states: {
        '#xmas': {
          indeterminate: '',
          style:
            'animation-delay: -0.9s; animation-play-state: paused; vertical-align: top;',
        },
      },
      fill: [0, 221, 259],
      barColor: { ...baseColor, a: [30, 31] },
    ...
    },
    {
      ...
      states: {
        '#xmas': {
          indeterminate: '',
          style:
            'animation-delay: -1.35s; animation-play-state: paused; vertical-align: top;',
        },
      },
      fill: [0, 100, 260, 120],
      barColor: { ...baseColor, a: [30, 31] },
    ...
    },
    {
      ...
      states: {
        '#xmas': {
          indeterminate: '',
          style:
            'animation-delay: -1.8s; animation-play-state: paused; vertical-align: top;',
        },
      },
      fill: [0, 480],
      barColor: { ...baseColor, a: [30, 31] },
    ...
    },
    {
      ...
      states: {
        '#xmas': {
          value: 50,
          style: 'vertical-align: top;--uiseek-primary-rgb: 255, 0, 0;',
        },
      },
      fill: [240, 240],
    ...
    describe(`in ${suite.label} state`, () => {
      ...
      beforeAll(async () => {
        style = setUp(
          'src/components/progress/linear/progress-linear',
          suite.states
        );
      ...
      it(`should have corresponding fill`, () => {
        const im = {
          ...suite.barColor,
          a: [suite.barColor.a[0], suite.fillColor.a],
        };

        const row = suite.fill.reduce((array, length, index) => {
          const segment = new Array(length).fill(
            index % 2 ? suite.barColor : suite.fillColor
          );
          if (segment.length) {
            segment[0] = im;
            segment[length - 1] = im;
