...
describe('Circular Progress', () => {
  ...
  [
    ...
    },
    {
      ...
      states: {
        '#xmas': {
          indeterminate: '',
          style:
            '--uiseek-primary-rgb: 255, 0, 0;animation-delay: 0s; animation-play-state: paused;',
        },
      },
      fill: [346, 0],
    ...
    describe(`in ${suite.label} state`, () => {
      ...
      beforeAll(async () => {
        style = setUp(
          'src/components/progress/circular/progress-circular',
          suite.states
        );
      ...
      it(`should have corresponding fill`, () => {
        ...
        isBrowserNot('Safari') &&
          expect(indicator).toResembleCircularShape(slice, ...suite.fill);
      });
  ...
  describe('in smaller size', () => {
    ...
    beforeAll(async () => {
      style = setUp('src/components/progress/circular/progress-circular', {
        '#sized': {
          indeterminate: '',
          style:
            'font-size: 12px; animation-delay: 0s; animation-play-state: paused;',
        },
      });
    ...
    it(`should have corresponding fill`, () => {
      ...
      isBrowserNot('Safari') &&
        expect(indicator).toResembleCircularShape(slice, 346.5, 0);
    });
