...
describe('Tooltip', () => {
  [
    ...
    },
    {
      ...
      states: {
        '#xmas': {
          style:
            '--uiseek-surface-rgb: 0, 0, 0;--uiseek-onsurface-rgb: 255, 255, 255;position: relative;width: 120px;height: 20px;',
          hover: '',
        },
      },
    ...
    describe(`in ${suite.label} state`, () => {
      ...
      beforeAll(async () => {
        ...
        style +=
          '.uiseek-tooltip > span, .uiseek-tooltip-top > span {min-width: 56px; position: relative;}';
      ...
      it('should have caption text', () => {
        ...
        const tooltip = document.querySelector('#xmas > .uiseek-tooltip');
      ...
      it(`should have 4px round corners`, () => {
        ...
        const bottomRight = context.getImageData3x(
          20 + width,
          24 + height,
          4,
          4
  ...
  describe('top variant in hover state', () => {
    ...
    it('should have dominant { r: [95, 96], g: [95, 96], b: [95, 96], a: 230} color', () => {
      ...
      expect(component).toResembleColor({
        r: [95, 96],
        g: [95, 96],
        b: [95, 96],
        a: 230,
